...
class mock:
    ...
    afnp2014 = get_input(CHC = [[ ["P"] , ["I"]] , [ ["I", "B", "T"] , ["I"] ], [ ["I", "~B" ] , ["Q"] ] ],
                DNFs = {"P":np.array([[[1, 0, 0, 1], [0, 1, 0, 0] ]]),
                "B":np.array([[[0, 1, -2, 1000]]]),
                "Q":np.array([[[1, -1, 1, 0]]])
                } ,
                trans_funcs = { "T":repr.SimpleTotalTransitionFunc(np.array([[1, 1, 0], [0, 1, 1],  [0, 0, 1]])) 
                } , 
                invs = ["I"]
                )  
