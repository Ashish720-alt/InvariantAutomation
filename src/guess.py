...
def uniformlysampleLII(Dp, c, d, n):
    def uniformlysampleLIcc(Dp, n, c):
        ...
        return cc
    return [uniformlysampleLIcc(Dp, n, c) for i in range(d) ]
            ...
            if ( k > sum(degp_list)):
                ...
                for vindex, deg in enumerate(degp_list):
                    if (k > deg):
                        ...
                        if (deg == 2):
                            if (k == 1):
                                I[ccindex][pindex][vindex_actual] = I[ccindex][pindex][vindex_actual] + 1
                            else:
                                I[ccindex][pindex][vindex_actual] = I[ccindex][pindex][vindex_actual] - 1
                        else: 


# A = deg_list( uniformlysampleLII( (range(-10, 10, 1), range(-10,10,1) ), 4, 2, 3 ) , (range(-10, 10, 1), range(-10,10,1) ) )
# print( A , deg(A) )
