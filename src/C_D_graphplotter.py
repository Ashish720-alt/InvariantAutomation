import pprint
import main # So for this file to run, ensure that main has no function calls
...
def get_surface_graph_C_D(program, conj_min, disj_min, mesh_range, mesh_step_size, runs, PRINT_DICTIONARY, random_strategy, max_const=None, guess_range=None):
...
get_surface_graph_C_D(program =program,conj_min= 1, disj_min = 1, mesh_range= 2, mesh_step_size= 1, runs= 1, PRINT_DICTIONARY= 1,
